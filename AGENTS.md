...
| Header       | Descripción |
|-------------|-------------|
| `X-User-Id` | Identificador lógico del usuario (string). Usuarios demo en BD: `demo-free`, `demo-pro`, `demo-enterprise`. |
...
7. **Usuarios demo**
   - `demo-free`, `demo-pro`, `demo-enterprise` — útiles para probar límites distintos sin crear usuarios.
...
Todas requieren header **`X-User-Id`**.
